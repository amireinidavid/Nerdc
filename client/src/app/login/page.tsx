          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-10 z-10">
              ...
              >
                ...
                <p className="text-white/80 text-lg mb-6">Access your research, journals, and academic resources.</p>
          ...
          >
            <div className="max-w-md mx-auto">
              ...
              >
                ...
                <p className="text-indigo-200 mb-8">Access your journals, research papers and more</p>
              </motion.div>
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950 flex items-center justify-center">
        <div className="flex flex-col items-center">
          <div className="w-12 h-12 border-4 border-indigo-200/10 border-t-indigo-600 rounded-full animate-spin mb-4"></div>
