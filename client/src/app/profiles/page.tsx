        ...
        <div className="flex justify-between items-center w-full max-w-3xl mx-auto">
          {['user-type', 'basic-info', 'contact-info', ...(isResearcher ? ['researcher-info'] : []), 'confirmation'].map((step, index) => (
            <div key={step} className="flex flex-col items-center">
                ...
                className={`w-10 h-10 rounded-full flex items-center justify-center border-2 ${
                  currentStep === step 
                    ...
                    : stepCompleted[step as keyof typeof stepCompleted] 
                      ...
                      : 'border-gray-300 bg-slate-700/50 text-gray-300'
                }`}
              >
                {stepCompleted[step as keyof typeof stepCompleted] ? (
              ...
              <span className={`mt-2 text-xs ${currentStep === step ? 'text-indigo-400 font-medium' : 'text-gray-400'}`}>
          ...
          {['user-type', 'basic-info', 'contact-info', ...(isResearcher ? ['researcher-info'] : []), 'confirmation'].map((step, index, array) => {
            if (index < array.length - 1) {
              ...
              return (
                <div 
                  key={`line-${index}`} 
                  className={`flex-1 h-1 ${isCompleted ? 'bg-indigo-600' : 'bg-gray-600'}`}
                ></div>
              );
            }
            return null;
    ...
    switch (currentStep) {
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">Welcome to the Academic Community</h1>
              <p className="text-lg text-indigo-200">Please select your account type to continue</p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Regular User Option */}
              <motion.div 
                className={`relative overflow-hidden rounded-xl border-2 ${isResearcher ? 'border-gray-200/20' : 'border-indigo-600'} p-6 cursor-pointer transition-all hover:shadow-md bg-slate-800/50`}
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">Regular User</h3>
                  <p className="text-indigo-200">Access research journals, save favorites, and follow researchers in your field of interest.</p>
              ...
              {/* Researcher Option */}
              <motion.div 
                className={`relative overflow-hidden rounded-xl border-2 ${isResearcher ? 'border-indigo-600' : 'border-gray-200/20'} p-6 cursor-pointer transition-all hover:shadow-md bg-slate-800/50`}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              ...
              >
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-indigo-200">Publish your own research, participate in peer reviews, and build your academic profile.</p>
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-indigo-200">Tell us a bit about yourself</p>
            </div>
              ...
              <div className="grid grid-cols-1 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="bg-slate-800/70 border-white/10 text-white placeholder:text-gray-400"
                  />
                </div>
                ...
                <div>
                  <label htmlFor="profileImage" className="block text-sm font-medium text-indigo-200 mb-1">
                    Profile Image URL
                  </label>
                  <Input
                    id="profileImage"
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-indigo-200">How can others reach you?</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div>
                  <label htmlFor="address" className="block text-sm font-medium text-indigo-200 mb-1">
                    Address
                  </label>
                  <Input
                    id="address"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  ...
                  <div>
                    <label htmlFor="state" className="block text-sm font-medium text-indigo-200 mb-1">
                      State/Province
                    </label>
                    <Input
                      id="state"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                  <div>
                    <label htmlFor="postalCode" className="block text-sm font-medium text-indigo-200 mb-1">
                      Postal Code
                    </label>
                    <Input
                      id="postalCode"
              ...
              <h3 className="text-lg font-medium text-gray-900 border-b pb-2 mt-8">Social Profiles</h3>
     ...
     case 'researcher-info':
        return (
          ...
          >
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-white mb-2">Academic Information</h1>
              <p className="text-lg text-indigo-200">Tell us about your research experience</p>
            </div>
            
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="institution" className="block text-sm font-medium text-indigo-200 mb-1">
                    Institution*
                  </label>
                  <Input
                    id="institution"
                ...
                <div>
                  <label htmlFor="department" className="block text-sm font-medium text-indigo-200 mb-1">
                    Department
                  </label>
                  <Input
                    id="department"
              ...
              <div>
                <label htmlFor="position" className="block text-sm font-medium text-indigo-200 mb-1">
                  Position/Title
                </label>
                <Input
                  id="position"
              ...
              <div>
                <label htmlFor="researchInterests" className="block text-sm font-medium text-indigo-200 mb-1">
                  Research Interests
                </label>
                <Textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  <label htmlFor="publicationsCount" className="block text-sm font-medium text-indigo-200 mb-1">
                ...
                <div>
                  <label htmlFor="citationsCount" className="block text-sm font-medium text-indigo-200 mb-1">
                    Citations Count
                  </label>
                  <Input
                    id="citationsCount"
                ...
                <div>
                  <label htmlFor="hIndex" className="block text-sm font-medium text-indigo-200 mb-1">
                    h-index
                  </label>
                  <Input
                    id="hIndex"
              ...
              <div>
                <label htmlFor="googleScholarId" className="block text-sm font-medium text-indigo-200 mb-1">
              ...
              <div>
                <label htmlFor="orcidId" className="block text-sm font-medium text-indigo-200 mb-1">
                  ORCID ID (optional)
                </label>
                <Input
                  id="orcidId"
        ...
        return (
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-indigo-200">Please review your information and submit</p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6 mb-6 border border-white/10">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-indigo-300">Account Type</p>
                  <p className="font-medium text-white">{isResearcher ? 'Researcher' : 'Regular User'}</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-indigo-300">Name</p>
                ...
                {formData.bio && (
                  <div>
                    <p className="text-sm text-indigo-300">Bio</p>
                    <p className="font-medium text-white">{formData.bio}</p>
                  </div>
                )}
                ...
                {isResearcher && (
                  <>
                    <div className="border-t border-white/10 pt-4 mt-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm text-indigo-300">Institution</p>
                          <p className="font-medium text-white">{formData.institution || '–'}</p>
                        </div>
                        ...
                        <div>
                          <p className="text-sm text-indigo-300">Position</p>
                          <p className="font-medium text-white">{formData.position || '–'}</p>
                        </div>
                      </div>
                      
                      {formData.researchInterests && (
                        <div className="mt-2">
                          <p className="text-sm text-indigo-300">Research Interests</p>
                          <p className="font-medium text-white">{formData.researchInterests}</p>
                        </div>
                      )}
                    </div>
                  </>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-indigo-950 to-slate-950">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Form */}
        <div className="max-w-3xl mx-auto bg-slate-900/40 backdrop-blur-md shadow-xl shadow-black/10 rounded-xl p-8 border border-white/5">
